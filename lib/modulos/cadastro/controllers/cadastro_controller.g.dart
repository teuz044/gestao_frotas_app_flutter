...
mixin _$CadastroController on CadastroControllerBase, Store {
  late final _$_statusAtom =
      Atom(name: 'CadastroControllerBase._status', context: context);

  CadastroStateStatus get status {
    _$_statusAtom.reportRead();
    return super._status;
  }

  @override
  CadastroStateStatus get _status => status;

  @override
  set _status(CadastroStateStatus value) {
