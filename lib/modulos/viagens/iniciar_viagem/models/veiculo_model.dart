...
class VeiculoModel {
  ...
  factory VeiculoModel.fromJson(String source) => VeiculoModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'VeiculoModel(id: $id, placa: $placa, modelo: $modelo, marca: $marca, anoFabricacao: $anoFabricacao, anoModelo: $anoModelo, quilometragem: $quilometragem, cor: $cor, tipoCombustivel: $tipoCombustivel, dataCriacao: $dataCriacao, statusVeiculo: $statusVeiculo, volumeTanque: $volumeTanque, consumoMedioLitro: $consumoMedioLitro)';
  }

  @override
  bool operator ==(covariant VeiculoModel other) {
