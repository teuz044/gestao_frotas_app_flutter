...
class ClassEstilosTextos {
  ...
  static final pretoSize12w600Montserrat = GoogleFonts.montserrat(
    fontSize: 12, fontWeight: FontWeight.bold, color: Colors.black
  );

  static final pretoSize16w600Montserrat = GoogleFonts.montserrat(
    fontSize: 16, fontWeight: FontWeight.bold, color: Colors.black
  );

  static final pretoSize14w600Montserrat = GoogleFonts.montserrat(
